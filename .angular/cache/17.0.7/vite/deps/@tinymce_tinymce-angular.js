import {
  FormsModule,
  NG_VALUE_ACCESSOR
} from "./chunk-VNMYFVIL.js";
import {
  CommonModule,
  isPlatformBrowser
} from "./chunk-P3MMLRJH.js";
import {
  BehaviorSubject,
...
var Events = class _Events {
  ...
  static ɵfac = function Events_Factory(t) {
...
var EditorComponent = class _EditorComponent extends Events {
  ...
  static ɵfac = function EditorComponent_Factory(t) {
    return new (t || _EditorComponent)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(PLATFORM_ID), ɵɵdirectiveInject(TINYMCE_SCRIPT_SRC, 8));
  };
